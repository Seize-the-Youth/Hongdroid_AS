...
class MainActivity : AppCompatActivity() {
    ...
    private fun createImageFile(): File? {
        ...
        return File.createTempFile("JPEG_${timestamp}_", ".jog", storageDir)
    ...
    private fun setPermision() {
        val permission = object : PermissionListener {
            override fun onPermissionGranted() { // 설정해놓은 위험권한들이 허용되었을 경우 이 곳 수행
                Toast.makeText(this@MainActivity, "권한이 허용되었습니다", Toast.LENGTH_SHORT).show()
            }

            override fun onPermissionDenied(deniedPermissions: MutableList<String>?) { // 설정해놓은 위험권한들이 거부되었을 경우 이 곳 수행
        ...
        TedPermission.with(this)
            ...
            .setDeniedMessage("건한을 거부하셨습니다. [앱 설정] -> [권한] 항목에서 허용해주세요.")
